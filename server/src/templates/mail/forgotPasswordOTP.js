export const forgotPasswordOTP = (name, otp) => {
    return `
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h2 style="margin: 0px; color: #141414; line-height: 140%; text-align: center; word-wrap: break-word; font-family: georgia,palatino; font-size: 28px; font-weight: 700;"><span>Hi ${name}, <br> Forgot your password?</span></h2>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h6 style="margin: 0px; color: #141414; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Open Sans',sans-serif; font-size: 12px; font-weight: 400;"><span><span><span><span><strong>We received a request to reset your password. Enter the OTP code below to verify your identity.</strong></span></span></span></span></h6>
  <!--[if mso]></td></tr></table><![endif]-->
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; color: #a3b2c3; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-family: Lato, sans-serif; font-size: 14px; line-height: 19.6px;">If you did not request a password reset, please ignore this email or contact support at support@truematrix.ai</span></p>
  </div>

...
const EmailVerifyOtp = () => {
    const { verifyForgotPasswordOTPApi, user } = useAuth();
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setSubmitting }) => {
            await verifyForgotPasswordOTPApi(values);
            setSubmitting(false);
                    ...
                    <div className="flex justify-center items-center flex-col h-screen bg-white rounded-xl relative">
                        ...
                        <div className="p-8 flex justify-center items-center gap-5 flex-col shadow-md rounded-2xl my-5 border-[1px] login bg-white">
                            <h1 className="inline-flex items-center text-2xl mb-4 flex-col">
                                <LockClosedIcon className="h-8 w-8 mb-2 text-success" /> Email Verification
                            </h1>
                            ...
                            <form onSubmit={formik.handleSubmit} className="w-full">
                                ...
                                <Button
                                    ...
                                    className="mt-3"
                                    type="submit"
                                    disabled={formik.values.otp.length !== 4 || formik.isSubmitting}
                                >
                                    Verify Account
                                </Button>
                            </form>
